        ...
        <div class="form-grid">
          ...
          <div class="field-block full">
            ...
            <div class="field-with-action">
              <input class="field-input" id="fn-pass-new" name="password" type="password" minlength="6" placeholder="Senha (Mín 6 chars)" style="padding-right:112px;" required>
    ...
    <form id="editSalonForm" action="" method="POST">
      ...
      <div class="form-grid">
        ...
        <div class="field-block full">
          ...
          <div class="field-with-action">
            <input class="field-input" id="d-senha" name="password" type="password" minlength="6" placeholder="Nova palavra-passe" style="padding-right:75px;">
            <div class="field-inline-actions">
  ...
  <div class="modal" style="max-width:440px;">
    ...
    <form id="adminEmployeeForm">
      ...
      <div class="field-block">
        ...
        <div class="field-with-action">
          <input class="field-input" id="ae-senha" type="password" minlength="6" placeholder="Deixa em branco para manter a atual" style="padding-right:70px;">
          <div class="field-inline-actions">
